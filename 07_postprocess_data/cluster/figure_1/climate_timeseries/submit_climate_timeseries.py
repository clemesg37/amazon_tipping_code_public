...
JOB_NAME = "figure1_climate_timeseries"

artifact_dir = OUTPUT_ROOT / "07_postprocess_data" / "figure_1" / "climate_timeseries" / "slurm"
...
batch_script.write_text(
    "\n".join([
        ...
        f"srun python {SCRIPT_DIR / 'figure_1_plot_time_series_ET.py'}",
        "",
    ]),
    encoding="utf-8",
)
