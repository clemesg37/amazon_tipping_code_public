...
`final_amazon_area_ETresid_updated.csv` is the large all-species table created by `07_postprocess_data/cluster/sdm_area_change/create_full_dataset_area_change.py`. It is used by the local Figure 3 notebook.
...
`07_postprocess_data/local/sdm_area_change/final_amazon_area_ETresid_updated.csv`
